...
public class main {
	...
	public static void main(String[] args) {
		...
		KRKSolver k = new KRKSolver(b, true, 0); // HARDCODED, you need functions to determine final two
		
		k.findKRKMove(b); // Currently doesnt do anything, but needed to set mating parameters
//		System.out.println(k.findKRKMove(b));
		...
		System.out.println(k.isKingOnEdge(8));
		System.out.println(k.isRookOnMatingRowOrColumn(1));
